// Audit all meta descriptions for character count
const metaDescriptions = [
  ...
  { page: "CommercialServicesLanding", desc: "Austin & Marble Falls commercial plumber for restaurants, offices & businesses. 25% off first service for new customers. Same-day emergency repairs. (512) 368-9159." },
  ...
  { page: "About", desc: "Central Texas's trusted water heater experts since 2005. Specializing in tankless water heater installation, water heater repair & replacement. Licensed plumbers. 24/7 emergency service. Serving Austin to Marble Falls." },
];

console.log("\n📊 META DESCRIPTION CHARACTER COUNT AUDIT\n");
