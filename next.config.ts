        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://app.ecwid.com https://static.servicetitan.com https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://www.clarity.ms",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://app.ecwid.com",
              "font-src 'self' https://fonts.gstatic.com data:",
              "img-src 'self' data: blob: https: http:",
              "connect-src 'self' https://app.ecwid.com https://*.ecwid.com https://api.servicetitan.io https://www.google-analytics.com https://www.clarity.ms",
              "frame-src 'self' https://app.ecwid.com https://*.ecwid.com https://static.servicetitan.com",
              "worker-src 'self' blob:",
              "child-src 'self' blob: https://app.ecwid.com",
            ].join('; '),
          },
        ],
      },
