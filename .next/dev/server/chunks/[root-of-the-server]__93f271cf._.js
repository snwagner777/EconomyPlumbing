...
async function GET(req) {
    try {
        ...
        const tokens = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$openid$2d$client$2f$build$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["authorizationCodeGrant"](config, new URL(req.url), {
        ...
        if (!claims || !claims.email || typeof claims.email !== 'string') {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/admin-login?error=no_email', req.url));
        }
        if (!claims.sub || typeof claims.sub !== 'string') {
            console.error('[OAuth] Invalid subject in claims');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/admin-login?error=invalid_claims', req.url));
        }
        const isWhitelisted = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].isEmailWhitelisted(claims.email);
        if (!isWhitelisted) {
            console.error('[OAuth] Email not whitelisted:', claims.email);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/admin-login?error=unauthorized', req.url));
        }
        // Upsert OAuth user in database
        await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].upsertOAuthUser({
            id: claims.sub,
            email: claims.email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__93f271cf._.js.map