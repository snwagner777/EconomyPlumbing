...
"[project]/server/lib/generateH1.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateH1FromTitle(title) {
...
"[project]/server/lib/sitemapPing.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/**
 * Notify Google when sitemap is updated (e.g., new blog post published)
 */ __turbopack_context__.s([
    "notifySearchEnginesNewPage",
    ()=>notifySearchEnginesNewPage,
...
async function pingGoogleSitemap(sitemapUrl = 'https://www.plumbersthatcare.com/sitemap.xml') {
    try {
...
async function pingBingSitemap(sitemapUrl = 'https://www.plumbersthatcare.com/sitemap.xml') {
    try {
...
async function pingAllSearchEngines(sitemapUrl) {
...
function notifySearchEnginesNewPage(pageType) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$generateH1$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/lib/generateH1.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$sitemapPing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/lib/sitemapPing.ts [app-route] (ecmascript)");
;
;
;
;
async function GET(req) {
    try {
        const posts = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].getBlogPosts();
...
async function POST(req) {
    try {
        ...
        const postData = {
            ...body,
            h1: body.h1 || (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$generateH1$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateH1FromTitle"])(body.title)
        };
        const newPost = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].createBlogPost(postData);
        // Notify search engines about new page
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$lib$2f$sitemapPing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["notifySearchEnginesNewPage"])('blog post');
        // Invalidate SSR cache (new content published)
        if (/*TURBOPACK member replacement*/ __turbopack_context__.g.invalidateSSRCache) /*TURBOPACK member replacement*/ __turbopack_context__.g.invalidateSSRCache();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ae3a88b2._.js.map