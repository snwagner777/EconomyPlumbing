...
async function GET(req) {
    try {
        ...
        const [googleReviews, customReviews] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].getGoogleReviews(),
            __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].getApprovedReviews({
                limit: undefined,
                featured
            })
        ]);
        ...
        if (category) {
            allReviews = allReviews.filter((review)=>review.categories && Array.isArray(review.categories) && review.categories.includes(category));
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(allReviews);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10cc8ece._.js.map