...
var __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/crypto [external] (crypto, cjs)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/fs [external] (fs, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$node_modules$2f$mime$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@google-cloud/storage/node_modules/mime/index.js [app-route] (ecmascript)");
 ...
 */ class File extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$build$2f$esm$2f$src$2f$nodejs$2d$common$2f$service$2d$object$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ServiceObject"] {
    ...
    createWriteStream(options = {}) {
        ...
        if (!options.metadata.contentType || options.metadata.contentType === 'auto') {
            const detectedContentType = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$node_modules$2f$mime$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getType(this.name);
 ...
 */ class Bucket extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$build$2f$esm$2f$src$2f$nodejs$2d$common$2f$service$2d$object$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ServiceObject"] {
     ...
     */ combine(sources, destination, optionsOrCallback, callback) {
        ...
        if (!destinationFile.metadata.contentType) {
            const destinationContentType = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$node_modules$2f$mime$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getType(destinationFile.name) || undefined;
...
class TransferManager {
     ...
     */ async uploadManyFiles(filePathsOrDirectory, options = {}) {
        ...
        for (const filePath of allPaths){
            ...
            if (options.customDestinationBuilder) {
                ...
                let segments = filePath.split(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["sep"]);
                segments = segments.filter((s)=>s !== '');
                passThroughOptionsCopy.destination = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["posix"].join(...segments);
            }
            if (options.prefix) {
     ...
     */ async downloadManyFiles(filesOrFolder, options = {}) {
        ...
        for (const file of files){
            ...
            if (options.prefix) {
                name = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"](options.prefix, name);
            }
            // Reject absolute paths and traversal sequences
            if (__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["isAbsolute"](name)) {
                const absolutePathError = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$build$2f$esm$2f$src$2f$file$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RequestError"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$build$2f$esm$2f$src$2f$file$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FileExceptionMessages"].ABSOLUTE_FILE_NAME);
                throw absolutePathError;
            }
            // Resolve the final path and perform the containment check
            let finalPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["resolve"](baseDir, name);
            const normalizedBaseDir = baseDir.endsWith(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["sep"]) ? baseDir : baseDir + __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["sep"];
            if (finalPath !== baseDir && !finalPath.startsWith(normalizedBaseDir)) {
                const traversalError = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$build$2f$esm$2f$src$2f$file$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RequestError"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$build$2f$esm$2f$src$2f$file$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FileExceptionMessages"].TRAVERSAL_OUTSIDE_BASE);
                throw traversalError;
            }
            if (file.name.endsWith('/') && !finalPath.endsWith(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["sep"])) {
                finalPath = finalPath + __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["sep"];
            }
            const passThroughOptionsCopy = {
                ...options.passthroughOptions,
            ...
            const destinationDir = finalPath.endsWith(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["sep"]) ? finalPath : __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["dirname"](finalPath);
     ...
     */ _resolveAndValidateBaseDir(options) {
        ...
        const baseDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["resolve"]((_b = (_a = options.passthroughOptions) === null || _a === void 0 ? void 0 : _a.destination) !== null && _b !== void 0 ? _b : cwd);
        // Check for path traversal: baseDir must be equal to or contained within cwd.
        const relativeBaseDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["relative"](cwd, baseDir);
        // The condition checks for traversal ('..') or cross-drive traversal (absolute path on Windows)
        if (relativeBaseDir.startsWith('..') || __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["isAbsolute"](relativeBaseDir)) {
            const traversalError = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$build$2f$esm$2f$src$2f$file$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RequestError"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2d$cloud$2f$storage$2f$build$2f$esm$2f$src$2f$file$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FileExceptionMessages"].TRAVERSAL_OUTSIDE_BASE_DESTINATION);
            throw traversalError;
        }
        return baseDir;
    }
