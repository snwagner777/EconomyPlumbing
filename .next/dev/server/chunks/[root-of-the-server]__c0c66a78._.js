...
"[project]/app/api/webhooks/resend/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const wh = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$svix$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Webhook"](webhookSecret);
        let event;
        try {
...
async function handleEmailSent(emailId, emailAddress, data) {
    console.log('[Resend] Email sent:', emailId);
    // Log email send
    await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].logEmailSend({
        emailId,
...
async function handleEmailDelivered(emailId) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].updateEmailLog(emailId, {
        deliveredAt: new Date()
    });
}
async function handleEmailOpened(emailId) {
    console.log('[Resend] Email opened:', emailId);
    // Update opened timestamp
    const emailLog = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].getEmailLogByEmailId(emailId);
    if (!emailLog) {
    ...
    if (emailLog.campaignId) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].incrementCampaignEngagement(emailLog.campaignId, emailLog.campaignType, 'opened');
    }
}
async function handleEmailClicked(emailId, link) {
    ...
    // Update campaign engagement counters
    if (emailLog.campaignId) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].incrementCampaignEngagement(emailLog.campaignId, emailLog.campaignType, 'clicked');
    }
}
async function handleEmailBounced(emailId, emailAddress, bounceType) {
    ...
    if (bounceType === 'hard') {
        await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["storage"].addToSuppressionList({
            email: emailAddress,
            reason: 'hard_bounce',
...
async function handleEmailComplained(emailId, emailAddress) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c0c66a78._.js.map