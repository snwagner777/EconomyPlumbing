...
- **Admin Panel Image Display Fix (October 11, 2025):** Fixed broken image display in admin panel by correcting field name mismatches between frontend and backend (photo.url → photo.photoUrl, photo.description → photo.aiDescription, photo.aiQuality → photo.isGoodQuality). Images now display properly in the admin dashboard.
