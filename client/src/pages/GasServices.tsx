...
export default function GasServices() {
  return (
    <ServicePage
      title="Gas Line Installation & Repair Austin TX | Licensed Gas Technicians"
      metaDescription="Professional gas line installation for appliances, outdoor kitchens, fire pits & generators. Licensed gas fitters, safety inspections. Code-compliant work guaranteed."
