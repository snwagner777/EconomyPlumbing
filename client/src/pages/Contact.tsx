...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title="Contact Economy Plumbing | Schedule Service Austin TX"
        description="Get in touch with Economy Plumbing. Schedule service online or call for 24/7 emergency plumbing. Serving Austin, Marble Falls, and Central Texas communities."
