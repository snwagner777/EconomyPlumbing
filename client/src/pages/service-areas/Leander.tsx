  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content={serviceArea?.metaDescription || "Leander plumber serving Crystal Falls, Travisso, Mason Hills. Expert water heater repair, drain cleaning, leak detection. Same-day service. (512) 368-9159."} />
