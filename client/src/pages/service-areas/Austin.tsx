  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content={serviceArea?.metaDescription || "Austin plumber serving Downtown, South Congress, East Austin. Expert water heater repair, drain cleaning, leak detection. Same-day service. (512) 368-9159."} />
