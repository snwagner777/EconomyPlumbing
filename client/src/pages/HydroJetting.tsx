...
import hydroJetImage from "@assets/generated_images/Drain_cleaning_professional_service_e8a953c5.png";
...
export default function HydroJetting() {
  return (
    <ServicePage
      ...
      canonical="https://economyplumbingservices.com/hydro-jetting-services"
