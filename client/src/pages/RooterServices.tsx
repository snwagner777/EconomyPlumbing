...
import rooterImage from "@assets/generated_images/Drain_cleaning_professional_service_e8a953c5.png";
...
export default function RooterServices() {
  return (
    <ServicePage
      ...
      canonical="https://economyplumbingservices.com/rooter-services"
