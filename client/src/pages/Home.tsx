...
import { Droplets, Wind, Wrench, Bath, Building2, AlertCircle, Flame, Shield } from "lucide-react";
import { DollarSign, BadgeCheck, Award, Users, CheckCircle, Truck } from "lucide-react";
...
export default function Home() {
  const services = [
    ...
    },
    {
      ...
      description: "Fast response for plumbing emergencies when you need help most.",
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Our Plumbing Services</h2>
      ...
      <section className="py-16 lg:py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Why Choose Our Plumbing Services?</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Our Service Areas</h2>
      ...
      <section className="py-16 lg:py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Don't just take our word for it. Here's what our satisfied customers have to say about Economy Plumbing Services.
            </p>
            <div className="mt-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((testimonial) => (
              <TestimonialCard key={testimonial.name + testimonial.service} {...testimonial} />
            ))}
          </div>
        </div>
      </section>
