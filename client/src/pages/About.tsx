...
export default function About() {
  ...
  return (
    <>
      <SEOHead
        title="About Economy Plumbing | Family-Owned Since 2005 | Austin TX"
        description="Family-owned plumbing company serving Central Texas since 2005. Licensed professionals specializing in water heaters, drain cleaning, and emergency plumbing services."
