...
/**
 * Water Heater Services Page - Server Component with SEO
 * 
...
interface WaterHeaterServicesPageProps {
  searchParams: Promise<{ [key: string]: string | string[] | undefined }>;
}

export async function generateMetadata(): Promise<Metadata> {
  return await getPageMetadata('/water-heater-services', {
    title: 'Water Heater Repair & Installation Austin TX | Expert',
    description: 'Expert water heater repair, installation & replacement in Austin. Tankless specialists, same-day service available. Licensed plumbers. Call (512) 368-9159.',
    ogImage: 'https://www.plumbersthatcare.com/attached_assets/optimized/Tankless_water_heater_closeup_7279af49.webp',
    ogType: 'website',
  });
}
...
export default async function WaterHeaterServices({ searchParams }: WaterHeaterServicesPageProps) {
  ...
  const canonical = 'https://www.plumbersthatcare.com/water-heater-services';
  const serviceSchema = createServiceSchema(
    'Water Heater Services',
    'Expert water heater repair, installation & replacement in Austin. Tankless specialists, same-day service available.',
    canonical
  );
  ...
  const breadcrumbSchema = createBreadcrumbListSchema([
    ...
    { name: "Water Heater Services", url: canonical }
  ]);
  ...
  return (
    <>
      ...
      <ServicePage
        ...
        canonical={canonical}
        heroImage="/attached_assets/optimized/Tankless_water_heater_closeup_7279af49.webp"
