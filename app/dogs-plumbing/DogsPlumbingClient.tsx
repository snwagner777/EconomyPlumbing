            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {images.map((image, index) => {
                  const shareUrl = `https://www.plumbersthatcare.com/dogs-plumbing?image=${image.id}`;
                  const shareText = `Check out this adorable AI-generated dog plumber from Economy Plumbing Services! 🐕🔧`;
