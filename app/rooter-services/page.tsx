...
export async function generateMetadata(): Promise<Metadata> {
  return await getPageMetadata('/rooter-services', {
    title: 'Rooter Service Austin TX | Sewer Line Cleaning Expert',
    description: 'Expert rooter & sewer line cleaning in Austin. Clear tough clogs, remove tree roots & eliminate grease buildup. Residential & commercial. Call (512) 368-9159.',
    ogImage: 'https://www.plumbersthatcare.com/attached_assets/optimized/Drain_cleaning_professional_service_e8a953c5.webp',
    ogType: 'website',
  });
}

export default async function RooterServices() {
  ...
  const serviceSchema = createServiceSchema(
    "Rooter Services",
    "Professional rooter and sewer line cleaning services for residential and commercial properties. Expert clog removal, tree root removal, and drain cleaning.",
    "https://www.plumbersthatcare.com/rooter-services"
  );
  ...
  const breadcrumbs = createBreadcrumbListSchema([
    ...
    { name: "Rooter Services", url: "https://www.plumbersthatcare.com/rooter-services" }
  ]);
  ...
  return (
    <>
      ...
      <ServicePage
        title="Rooter Service Austin TX | Sewer Line Cleaning Expert"
        metaDescription="Expert rooter & sewer line cleaning in Austin. Clear tough clogs, remove tree roots & eliminate grease buildup. Residential & commercial. Call (512) 368-9159."
