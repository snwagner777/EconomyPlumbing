...
interface BackflowTestingPageProps {
  searchParams: Promise<{ [key: string]: string | string[] | undefined }>;
}

export async function generateMetadata(): Promise<Metadata> {
  return await getPageMetadata('/backflow-testing', {
...
export default async function BackflowTesting({ searchParams }: BackflowTestingPageProps) {
  await searchParams;
  ...
  const breadcrumbSchema = createBreadcrumbListSchema([
    ...
    { name: "Backflow Testing", item: "https://www.plumbersthatcare.com/backflow-testing" }
  ]);
