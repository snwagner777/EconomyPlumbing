...
interface PermitResolutionPageProps {
  searchParams: Promise<{ [key: string]: string | string[] | undefined }>;
}

export async function generateMetadata(): Promise<Metadata> {
  return await getPageMetadata('/permit-resolution-services', {
    title: 'Plumbing Permit Resolution Austin TX | Code Experts',
    description: 'Resolve plumbing permit issues and code violations in Austin. Fix unpermitted work for home sales, work with city inspectors. Call (512) 368-9159 now.',
    ogType: 'website',
  });
}
...
export default async function PermitResolution({ searchParams }: PermitResolutionPageProps) {
  ...
  const canonical = 'https://www.plumbersthatcare.com/permit-resolution-services';
  const serviceSchema = createServiceSchema(
    'Permit Resolution Services',
    'Resolve plumbing permit issues and code violations in Austin. Fix unpermitted work for home sales.',
    canonical
  );
  ...
  const breadcrumbSchema = createBreadcrumbListSchema([
    ...
    { name: "Permit Resolution Services", url: canonical }
  ]);
  ...
  return (
    <>
      ...
      <ServicePage
        ...
        canonical={canonical}
        heroImage="/attached_assets/optimized/Plumber_installing_water_heater_3f7d8a09.webp"
