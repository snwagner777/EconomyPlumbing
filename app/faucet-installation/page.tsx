...
interface FaucetInstallationPageProps {
  searchParams: Promise<{ [key: string]: string | string[] | undefined }>;
}

export async function generateMetadata(): Promise<Metadata> {
  return await getPageMetadata('/faucet-installation', {
    title: 'Faucet Installation Austin TX | Kitchen & Bathroom Pro',
    description: 'Professional faucet installation & repair in Austin for kitchen, bathroom & shower. Touchless faucets, fixture upgrades & leak repairs. Call (512) 368-9159.',
    ogType: 'website',
  });
}
...
export default async function FaucetInstallation({ searchParams }: FaucetInstallationPageProps) {
  ...
  return (
    <>
      ...
      <ServicePage
        title="Faucet Installation Austin TX | Kitchen & Bathroom Pro"
        metaDescription="Professional faucet installation & repair in Austin for kitchen, bathroom & shower. Touchless faucets, fixture upgrades & leak repairs. Call (512) 368-9159."
